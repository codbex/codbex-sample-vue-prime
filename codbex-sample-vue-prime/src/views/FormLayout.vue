...
const passwordRepeat2 = ref(null);
</script>
            ...
            <div class="md:w-1/2">
                ...
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="flex flex-col grow basis-0 gap-2">
                            <label for="passwordRepeat2">Password Repeat</label>
                            <Password v-model="passwordRepeat2" toggleMask />
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-4 allign-right">
            ...
            <div class="md:w-1/2">
                <div class="card flex flex-col gap-4">
                    ...
                    <div class="grid grid-cols-12 gap-2">
                        <label for="name3" class="flex items-center col-span-12 mb-2 md:col-span-3 md:mb-0">Name</label>
                        <div class="col-span-12 md:col-span-9">
                            <InputText id="name3" type="text" />
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        <label for="email3" class="flex items-center col-span-12 mb-2 md:col-span-3 md:mb-0">Email</label>
                        <div class="col-span-12 md:col-span-9">
                            <InputText id="email3" type="text" />
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        <label for="date3" class="flex items-center col-span-12 mb-2 md:col-span-3 md:mb-0">Date</label>
                        <div class="col-span-12 md:col-span-9">
                            <DatePicker name="date" />
                        </div>
                    </div>
                    <div class="grid grid-cols-12 gap-2">
                        <label for="agreeToTerms" class="flex items-center col-span-12 mb-2 md:col-span-3 md:mb-0">Agree to terms</label>
                        <div class="col-span-12 md:col-span-9">
                            <ToggleSwitch name="agreeToTerms" />
                        </div>
                    </div>
                </div>
